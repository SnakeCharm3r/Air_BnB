...
class MaintenanceController extends Controller
{
    public function index()
    {
        ...
        // Get staff and rooms for dropdowns
        $staff = DB::table('staff')->where('is_active', true)->get();
        $rooms = DB::table('rooms')->get();

        return view('maintenance.index', compact('tasks', 'staff', 'rooms'));
    }
    ...
    public function show($id)
    {
        $task = DB::table('maintenance_tasks')
            ->leftJoin('rooms', 'maintenance_tasks.room_id', '=', 'rooms.id')
            ->leftJoin('staff', 'maintenance_tasks.assigned_to', '=', 'staff.id')
            ->select('maintenance_tasks.*', 'rooms.room_number', 'staff.full_name as assigned_to_name')
        ...
        return view('maintenance.show', compact('task'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        DB::table('maintenance_tasks')->where('id', $id)->update($data);
