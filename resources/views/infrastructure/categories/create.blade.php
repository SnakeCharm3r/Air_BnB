...
@section('page-title', 'Add Infrastructure Category')
...
<div class="space-y-6 max-w-2xl mx-auto">
    <div class="flex items-center gap-2">
        ...
        <h2 class="text-xl font-bold text-slate-800">Add Category</h2>
    </div>

    <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-6">
        <form action="{{ route('infrastructure.categories.store') }}" method="POST" class="space-y-6">
            @csrf
            <div>
            ...
            <div>
                ...
                <input type="text" name="icon" placeholder="e.g. tv, wind, video" class="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500">
            </div>
            <div>
            ...
            <div class="flex items-center gap-2">
                <input type="checkbox" name="is_active" value="1" checked id="is_active" class="w-4 h-4 text-emerald-600 border-slate-300 rounded focus:ring-emerald-500">
            ...
            <div class="flex justify-end gap-3">
                ...
                <button type="submit" class="px-4 py-2 bg-emerald-500 hover:bg-emerald-600 text-white rounded-lg text-sm font-medium transition">Save Category</button>
            </div>
        </form>
    </div>
</div>
